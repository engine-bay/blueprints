namespace EngineBay.Blueprints
{
    ...
    public class QueryFilteredTriggerBlueprints : PaginatedQuery<TriggerBlueprint>, IQueryHandler<FilteredPaginationParameters<TriggerBlueprint>, PaginatedDto<TriggerBlueprintDto>>
    {
        private readonly BlueprintsQueryDbContext db;

        public QueryFilteredTriggerBlueprints(BlueprintsQueryDbContext db)
        {
            this.db = db;
        }
